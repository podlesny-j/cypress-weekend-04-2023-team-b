describe('First Task', () => {
  const baseURL = 'https://www.kiwi.com/en/country/china/?botview=1'
  ...
  it('Visiting URL', () => {
    cy.get('h1')
      .should('have.text', 'Plane tickets to China')
      .as('H1Text')
      .then($h1Text => {
    ...
    cy.get("h2[class='Heading__StyledHeading-sc-5yahaw-0 fVgiXr']")
    ...
    cy.get("h3[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
    ...
    const H3Text_ = cy
      .get("h3[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
      .eq(1)
      .should('have.text', 'Popular airlines flying to China')
    H3Text_.then($h3Text_ => {
      const _H3_ = $h3Text_.text()
      cy.log('Text ' + _H3_ + ' je overený.')
    })

    const Airports_in_China = cy
      .get("h3[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
      .eq(2)
      .should('have.text', 'Airports in China')
    ...
    const Airports_near_China = cy
      .get("h3[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
      .eq(3)
      .should('have.text', 'Airports near China')
    ...
    const Popular_flights = cy
      .get("h2[class='Heading__StyledHeading-sc-5yahaw-0 fVgiXr']")
      .eq(2)
      .should('have.text', 'Popular flights')
    ...
    const Cheap_flights = cy
      .get("h2[class='Heading__StyledHeading-sc-5yahaw-0 fVgiXr']")
      .eq(3)
      .should('have.text', 'Cheap flights')
    ...
    const Europe = cy
      .get("div[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
      .eq(0)
    ...
    const South_America = cy
      .get("div[class='Heading__StyledHeading-sc-5yahaw-0 dNjoEc']")
      .eq(4)
      .should('have.text', 'South America')
    ...
    describe('Check URLs', () => {
      const webPages = [
        'https://www.kiwi.com/en/airline/dr/ruili-airlines/',
      ...
      webPages.forEach(URL => {
        it(`Should redirect ${URL} with status code 200`, () => {
